...
function generatePharmaResponse(query) {
  ...
  if (q.includes("meddra") || q.includes("whodrug") || q.includes("medical coding") || /\b(soc|pt|llt|hlt|hlgt|smq)\b/i.test(q)) {
    return {
...
fs.writeFileSync('engines/pharmaBrain.js', brainSource, 'utf8');
console.log('Successfully written clean engines/pharmaBrain.js');
